          ...
          <div className="pt-20 lg:pt-12 pb-20">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white border border-border rounded-lg p-8 mb-12 shadow-sm">
                  <h2 className="font-playfair font-bold text-2xl md:text-3xl text-brand-white mb-6">Featured App: AI Academy for Kids</h2>
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div><img src="/lovable-uploads/ai-academy-screenshot.jpeg" alt="AI Academy for Kids" className="w-full max-w-sm mx-auto rounded-lg shadow-2xl border-glow" /></div>
                    <div>
                      <p className="text-brand-white/70 text-lg leading-relaxed mb-4">A fun and interactive academy where kids ages 7–16 discover how AI works through stories, games, and hands-on projects with Scout the robot and friends.</p>
                      <Button onClick={() => window.open('https://ai-academy.me', '_blank')} className="bg-brand-red hover:bg-brand-red/90 text-white font-bold px-6 py-3 hover-glow">Visit AI Academy →</Button>
                    </div>
                  </div>
                </div>
