                ...
                <div className="grid md:grid-cols-2 gap-12">
                  ...
                  <div className="animate-slide-in-right space-y-8">
                    <div>
                      ...
                      <a href="mailto:amber@amberyaghi.org" className="text-brand-red hover:underline transition-colors text-lg block">amber@amberyaghi.org</a>
                      <a href="mailto:contact@amberyaghi.org" className="text-brand-red hover:underline transition-colors text-lg block">contact@amberyaghi.org</a>
                    </div>
                    <div>
                    ...
                    <div className="bg-white border border-border rounded-lg p-6 shadow-sm">
                      <p className="text-brand-white/60 italic">We'd love your feedback on our services, books, or apps. Don't hesitate to share your thoughts!</p>
                    </div>
                  </div>
                </div>
              </div>
