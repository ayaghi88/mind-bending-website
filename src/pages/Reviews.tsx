...
const StarRating = ({ rating }: { rating: number }) => (
  <div className="flex gap-1">
    {Array.from({ length: 5 }).map((_, i) => (
      <Star
        key={i}
        className={`w-5 h-5 ${i < rating ? 'text-brand-gold fill-brand-gold' : 'text-brand-white/20'}`}
      />
    ))}
  </div>
);
        ...
        <div className="pt-24 pb-20">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              ...
              >
                <h1 className="font-playfair font-black text-4xl md:text-5xl lg:text-6xl text-brand-white mb-4">
                  Reviews & Testimonials
                </h1>
                <p className="text-brand-white/60 text-lg md:text-xl max-w-2xl mx-auto">
                  What readers, professionals, and reviewers are saying about Amber's work.
                </p>
              </motion.div>
              ...
              >
                <div className="flex gap-1 mb-2">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <Star key={i} className="w-8 h-8 text-brand-gold fill-brand-gold" />
                  ))}
                </div>
                      ...
                      {testimonials.map((t, i) => (
                        <div key={i} className="flex-[0_0_100%] min-w-0 px-2 md:flex-[0_0_80%] lg:flex-[0_0_60%]">
                          <div className="bg-white/5 border border-brand-white/10 rounded-xl p-8 md:p-10 relative">
                            ...
                            <blockquote className="text-brand-white/80 text-lg leading-relaxed my-6 italic">
                              "{t.quote}"
                            </blockquote>
                            <div>
                ...
                >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      name="book"
                      required
                      className="w-full rounded-lg border border-brand-white/10 bg-brand-black px-4 py-3 text-brand-white focus:outline-none focus:ring-2 focus:ring-brand-red/50 transition appearance-none"
                    >
