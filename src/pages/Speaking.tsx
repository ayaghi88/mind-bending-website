            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="mb-12 animate-fade-in">
                <div className="bg-white rounded-xl shadow-md border border-border overflow-hidden">
                  <img
                    src="/lovable-uploads/speaking-engagement.jpeg"
                    alt="Amber Yaghi featured as a speaker at a past speaking engagement alongside other authors and speakers"
                  ...
                  <div className="p-6">
                    ...
                    >
                      View Full Speaker Profile & Past Engagements <ExternalLink className="w-4 h-4" />
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-12 bg-white rounded-xl shadow-md border border-border p-6 animate-fade-in">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-brand-white/70 mb-3">
              ...
              <div className="mb-12 bg-gradient-to-br from-brand-red/5 to-brand-gold/5 border-2 border-brand-red/30 rounded-xl p-8 text-center animate-fade-in">
                ...
                <h2 className="font-playfair font-bold text-2xl md:text-3xl text-brand-white mb-4">
                  🌟 Nominate Amber for a TED Talk! 🌟
                </h2>
                <p className="text-brand-white/70 text-lg mb-4 max-w-2xl mx-auto">
                  Amber's transformational message about authenticity, mind-bending, and ethical technology deserves a global stage. 
                  Your nomination can help make that happen — it only takes a minute!
                </p>
                <p className="text-brand-gold font-semibold mb-6">
                  Every nomination counts. Help amplify a voice that inspires change.
                </p>
                <a
                  href="https://speaker-nominations.ted.com"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Button className="bg-brand-red hover:bg-brand-red/90 text-white font-bold px-10 py-5 text-lg hover-glow">
                    Nominate Amber for TED →
                  </Button>
                </a>
              </div>
